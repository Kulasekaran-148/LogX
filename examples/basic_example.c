 ...
 * @brief This example demonstrates how to setup logx in your project and use it for logging.
 * It also demonstrates setting all the configuration settings and log levels.
 * @version 0.1
 * @date 2025-11-10
 *
