...
const logx_field_desc_t LOGX_FIELD_TABLE[] = {
    ...
    {LOGX_KEY_COMPRESS,
     "logx",
     LOGX_FIELD_BOOL,
     offsetof(logx_cfg_t, rotate.compress),
     {.int_default = LOGX_DEFAULT_CFG_COMPRESS}},
    {LOGX_KEY_DELAY_COMPRESS,
     "logx",
     LOGX_FIELD_BOOL,
     offsetof(logx_cfg_t, rotate.delay_compress),
     {.int_default = LOGX_DEFAULT_CFG_DELAY_COMPRESS}},
